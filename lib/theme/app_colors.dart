...
class AppColors {
  ...
  static const Color accentGrey = Color(0xFF000000);
  static const Color dodgerBlue = Color(0xFF3F8CFF);
  static const Color sunsetOrange = Color(0xFFFF4D4D);
  static const Color mediumOrchid = Color(0xFFBA59FE);
