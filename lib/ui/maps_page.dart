...
class _MapsPageState extends State<MapsPage> {
  ...
  double latitude = 10.588016772109414;
  double longitude = 107.06048011779785;
  String address = "Vung Tau, Vietnam";
  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      latitude = args['latitude'] ?? 10.588016772109414;
      longitude = args['longitude'] ?? 107.06048011779785;
      address = args['address'] ?? "Vung Tau, Vietnam";

      logger.log(
          'MapsPage initialized with latitude: $latitude, longitude: $longitude, address: $address');
      setState(() {
        _destinationPosition = LatLng(latitude, longitude);
      });
    } else {
      logger.log('No arguments passed to MapsPage');
    }
  }
  ...
  Future<void> _loadMarkerImage() async {
    final ByteData bytes =
        await rootBundle.load('assets/images/backgrounds/currentLocation.png');
    mapController?.addImage('location', bytes.buffer.asUint8List());
  }

  Future<void> _loadMarkerEndImage() async {
    final ByteData bytes =
        await rootBundle.load('assets/images/backgrounds/locationEnd.png');
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            Image.asset(AppAssetsIcons.locationIc),
                            Expanded(
                              child: Padding(
                                padding:
            ...
            child: Center(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Image.asset(AppAssetsIcons.gpsIc),
                ),
              ),
            ),
          ),
