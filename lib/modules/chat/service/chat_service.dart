...
class ChatService {
  ...
  void initialize(String token, int taskerId, String senderType) {
    if (_isDisposed) {
      logger.log(
    ...
    logger.log('ChatService initialized with taskerId: $_taskerId');
  }
  ...
  Future<bool> connect() async {
    if (_accessToken == null || _taskerId == null) {
  ...
  void _onConnect(StompFrame frame) {
    ...
    try {
      ...
      String destination = '/queue/tasker.$_taskerId';
