...
import 'package:home_service_tasker/providers/api_provider.dart';
...
class ChatRepo {
  ...
  // Modified to check both possible token keys and add better error handling
  ...
  // Modified to ensure token is available before API call
  Future<List<ChatRoomModel>> getChatRooms(int taskerId) async {
    try {
      ...
      logger.log(
          'Getting chat rooms for taskerId: $taskerId with token: ${_authToken?.substring(0, 10)}...');
