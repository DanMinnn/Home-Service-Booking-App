...
class _EditProfileState extends State<EditProfile> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: _SaveButton(
                    enabled: !_isEmpty, backgroundColor: AppColors.blue),
              ),
  ...
  void _pickImage() {
    ...
    print("Image picker would open here");
  }
...
class _SaveButton extends StatelessWidget {
  ...
  const _SaveButton({required this.backgroundColor, required this.enabled});
    ...
    return ElevatedButton(
      onPressed: enabled
          ? () {
              ...
              print("Profile changes would be saved here");
            }
          : null,
